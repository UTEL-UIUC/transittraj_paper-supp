...
suppressWarnings(
  pdftools::pdf_convert(
    pdf = "C:\\Users\\obrie\\OneDrive - University of Illinois - Urbana\\IndyGo Project\\Deliverables\\Papers\\JPT\\images\\figure_4.pdf",
    filenames = "figures/figure_4.png",
    format = "png", dpi = 500
  )
)
```
...
knitr::include_graphics(path = "figures/figure_4.png")
```
...
suppressWarnings(
  pdftools::pdf_convert(
    pdf = "C:\\Users\\obrie\\OneDrive - University of Illinois - Urbana\\IndyGo Project\\Deliverables\\Papers\\JPT\\images\\figure_6.pdf",
    filenames = "figures/figure_6.png",
    format = "png", dpi = 500
  )
)
```
...
knitr::include_graphics(path = "figures/figure_6.png")
```
...
gganimate::anim_save(animation = map_anim,
                     filename = "C:/Users/obrie/OneDrive - University of Illinois - Urbana/IndyGo Project/Deliverables/Papers/JPT/videos/video_1.mp4",
                     # duration = 3, fps = 3,
                     duration = 30, fps = 30,
                     height = 1280, width = 720, units = "px", scaling = 2.5,
                     renderer = gganimate::av_renderer(),
                     device = "ragg_png")

av::av_video_images(video = "C:/Users/obrie/OneDrive - University of Illinois - Urbana/IndyGo Project/Deliverables/Papers/JPT/videos/video_1.mp4",
                    destdir = "C:/Users/obrie/OneDrive - University of Illinois - Urbana/IndyGo Project/Deliverables/Papers/JPT/videos/video_1_thumbnail.",
                    format = "png",
                    trim = "3:4")
```

``` {r, echo = FALSE}
vembedr::embed_url("https://www.youtube.com/watch?v=hCGx4Ki3GRM") %>%
  use_align("center")
```
...
``` {r, eval = FALSE, echo = FALSE}
gganimate::anim_save(animation = line_anim,
                     filename = "C:/Users/obrie/OneDrive - University of Illinois - Urbana/IndyGo Project/Deliverables/Papers/JPT/videos/video_2.mp4",
                     # duration = 3, fps = 3,
                     duration = 30, fps = 30,
                     height = 1280, width = 720, units = "px", scaling = 2.5,
                     renderer = gganimate::av_renderer(),
...
av::av_video_images(video = "C:/Users/obrie/OneDrive - University of Illinois - Urbana/IndyGo Project/Deliverables/Papers/JPT/videos/video_2.mp4",
                    destdir = "C:/Users/obrie/OneDrive - University of Illinois - Urbana/IndyGo Project/Deliverables/Papers/JPT/videos/video_2_thumbnail",
                    format = "png",
                    trim = "3:4")
```

``` {r, echo = FALSE}
vembedr::embed_url("https://www.youtube.com/watch?v=60AkEtYd9O0") %>%
  use_align("center")
```
...
``` {r, eval = FALSE, echo = FALSE}
# - Knit -
knitr::knit(input = "vignettes/raw-tspm.Rmd",
            output = "vignettes/tspm.md")
```
